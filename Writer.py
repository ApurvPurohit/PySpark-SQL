...
def writefile():
    ...
    query_1 = """
              ...
              """
    cursor = execute_sql("UhcProvider", query_1, empty_list)
    query_2 = """ 
              ...
              """
    cursor = execute_sql("UhcProvider", query_2, empty_list)
    query_3 = """      
                          UPDATE  Provider.dbo.OxfordCurrentProviderInformation 
                ...
                """
    cursor = execute_sql("UhcProvider", query_3, empty_list)
    query_4 = """ 
                      DELETE FROM Provider.dbo.OxfordCurrentProviderInformation
                                  WHERE ProviderID = '999999';
                      DELETE FROM Provider.dbo.OxfordProviderChangeAddTerm;
              """
    cursor = execute_sql("UhcProvider", query_4, empty_list)
    query_5 = """
                      SELECT     OPPI.* 
              ...
              """
    cursor = execute_sql("UhcProvider", query_5, empty_list)
    query_6 = """  
              ...
              """
    cursor = execute_sql("UhcProvider", query_6, empty_list)
    query_7 = """
              ...
              """
    cursor = execute_sql("UhcProvider", query_7, empty_list)
    query_8 = """                   
                        DELETE temp
              ...
              """
    cursor = execute_sql("UhcProvider", query_8, empty_list)
    query_9 = """
              ...
              """
    cursor = execute_sql("UhcProvider", query_9, empty_list)    
